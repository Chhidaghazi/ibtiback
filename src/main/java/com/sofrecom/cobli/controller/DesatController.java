...
public class DesatController {
		        ...
		        try {
		         if (service.isExisteDesat(desat)) {
		        	 ...
		        	 //Type prestation
		                 ...
		                 // recupere fonction calcul tarif si rturn tarif1 so taarifRepo.findByTypeTarif 
		               // Calcul date deadline
		                 ...
		                 c.add(Calendar.DATE, nbrjoursmax);
		                 dateDeadline = c.getTime();
		                 //String tt= tarifController.calculerTypeTarifDesat(null);
		                 
		                 // calcul tarif
		                 
		              
		          //  Tarification tar = repoTarif.findByCodeTarif(tarif);
	...
	// add desat methode 2
	    ...
	    //Get All Desats
			...
			//Get All Desats
			@GetMapping("/desatsNbre")
			public int getAllNbr(){
				return desatRepo.findAll().size();
