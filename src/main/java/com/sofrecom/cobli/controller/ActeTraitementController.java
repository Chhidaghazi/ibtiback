...
return new ResponseEntity<>(null, HttpStatus.INTERNAL_SERVER_ERROR);
		...
		// nbre totales des actes
		@GetMapping("/actesNbre")
		public int getAllNbre(){
			return acteTraitementRepository.findAll().size();


		}


	@GetMapping("/getactbyequipe")
	public List<Acte_traitement> getactbyequipe(@RequestParam int idequipe ){
